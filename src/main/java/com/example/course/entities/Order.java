...
public class Order implements Serializable {
	...
	private Instant moment; //instant substitui a classe Date
	
	private Integer orderStatus;
	
	//associações
	@ManyToOne
	@JoinColumn(name = "client_id") // muitos pedidos para um client
	private User client; //um pedido para um cliente
